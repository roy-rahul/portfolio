...
import { Input } from "@/app/ui/shadcn-components/input"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/app/ui/shadcn-components/sheet"
import { Skeleton } from "@/app/ui/shadcn-components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@/app/ui/shadcn-components/tooltip"
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-brand-600 group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
